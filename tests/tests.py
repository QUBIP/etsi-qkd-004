...
class TestQKDClient:
    ...
    def test_case1_ksid_sync(self, caplog):
        ...
        open_status_alice, alice_ksid, alice_qos = client_alice.open_connect('client://alice', f'server://{SERVER_ADDRESS}')
        ...
        open_status_bob, bob_ksid, bob_qos = client_bob.open_connect('client://bob', f'server://{SERVER_ADDRESS}')
